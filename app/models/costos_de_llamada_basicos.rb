class CostosDeLlamadaBasicos
  ...
  def initialize
    ...
    @costo_nacional = CostoDeLlamada.new(0.3, ->(llamada) {llamada.es_nacional? && !llamada.es_local?})
    ...
    @costo_internacional_resto = CostoDeLlamada.new(1.5, ->(llamada) {llamada.es_internacional? && (!llamada.llamada_a_sudamerica?)})
